...
// convert_image.php is taken from Qdig's "Alternate-sized Image Conversion" utility.
//
// @rno klein, 2007
/*
+----------------------------------------------------------------------+
...
* Paths: @rno
*/
$convert_cmd  = '/usr/bin/convert -format jpg';  // Full pathname to ImageMagick's `convert'
$input_image  = $_POST['input_image']; 
$output_image = $_POST['output_image']; 
...
// medium
$cnvrt_size[0]['prefix']  = '';
$cnvrt_size[0]['sharpen'] = '0.6x0.9';
$cnvrt_size[0]['maxwid']  = 640;
$cnvrt_size[0]['qual']    = 100;
...
{
	global  $imgs, $input_file, $output_file, $convert_cmd, $cnvrt_alt;
	...
	foreach ($imgs as $img_file) {
		$output_image = $cnvrt_arry['prefix'].$output_image;
